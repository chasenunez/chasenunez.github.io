...
tip = d3.tip()
  ...
  .direction('n')
  .html(function(d) {
    return nameById.get(d.id) + "<br/>Stand Age 100 change: " + (rateById.get(d.id)*100).toFixed(2)  + "%" +
    "<br/>Stand Age 30 change: " + (popById.get(d.id)*100).toFixed(2)+ "%"
 });
